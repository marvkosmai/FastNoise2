...
uint32<4> i_to_uint32(const float32<4>& a)
{
	...
	return uint32<4>( i_to_int32(sub(a, bit_and(is_large, splat<float32<4>>((float)0x100000000)))) );
#endif
}
...
uint32<8> i_to_uint32(const float32<8>& a)
{
	...
	return uint32<8>( i_to_int32(sub(a, bit_and(is_large, splat<float32<8>>((float)0x100000000)))) );
#endif
}
#endif
